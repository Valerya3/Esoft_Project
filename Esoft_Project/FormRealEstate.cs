...
namespace Esoft_Project
{
    public partial class FormRealEstate : Form
    {
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            Program.wtfDb.RealEstateSet.Add(realEstate);
        ...
        void ShowRealEstateSet()
        {
            ...
            foreach (RealEstateSet realEstate in Program.wtfDb.RealEstateSet)
            {
                if (realEstate.Type == 0)
                {
                    ListViewItem item = new ListViewItem(new string[]
                    {
                        ...
                        realEstate.Coordinate_latitude.ToString(), realEstate.TotalArea.ToString(),
        ...
        private void buttonEdit_Click(object sender, EventArgs e)
        {
            if (comboBoxType.SelectedIndex == 0)
            {
                if (listViewRealEstateSet_Apartment.SelectedItems.Count == 1)
                {
                    ...
                    realEstate.Rooms = Convert.ToInt32(textBoxRooms.Text);
                    realEstate.Floor = Convert.ToInt32(textBoxRooms.Text);
        ...
        private void buttonDel_Click(object sender, EventArgs e)
        {
            try
            {
                if (comboBoxType.SelectedIndex == 0)
                {
                    ...
                    {
                        RealEstateSet realEstate = listViewRealEstateSet_Apartment.SelectedItems[0].Tag as RealEstateSet;
                        Program.wtfDb.RealEstateSet.Remove(realEstate);
                        Program.wtfDb.SaveChanges();
                        ShowRealEstateSet();
                    }
                    textBoxAddress_City.Text = "";
